...
@Component({
  ...
  templateUrl: './admission-admin.component.html',
  styleUrls: ['./admission-admin.component.css']
})
export class AdmissionAdminComponent {
  ...
  ngOnInit() {
    ...
    this.getDailyvalidationLastMonth()
  ...
  getDailyvalidationLastMonth(): void{
    const today = new Date();
    const startOfLastMonth = new Date(today.getFullYear(), today.getMonth() - 1, 1);
    const endOfLastMonth = new Date(today.getFullYear(), today.getMonth(), 0);
